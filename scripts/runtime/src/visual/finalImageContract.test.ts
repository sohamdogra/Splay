...
test("accepts 16:9 dark-blue wave artwork", () => {
  const result = evaluateFinalImageContract(
    ...
    "Create a dark navy-blue Arvya social card with layered flowing waves and restrained gold detail."
  );
...
test("rejects extra-tall or off-theme artwork", () => {
  const tall = evaluateFinalImageContract(
    ...
    "Create a dark navy-blue Arvya social card with layered flowing waves."
  );
